    ...
    try {
      ...
      if (network.chainId !== 11155111 && network.chainId !== 31337) {
        await window.ethereum.request({
          ...
          params: [{ chainId: "0x7A69" }], // for localhost (31337)
        });
      }
      ...
      console.log("✅ Payment transaction mined:", receipt);

      // Fetch fresh on-chain data after payment
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (currentHackathonId !== null) {
        formData.append("hackathon_id", currentHackathonId);
      }
      else {
        console.log("hackathon_id: ", currentHackathonId)
      }
